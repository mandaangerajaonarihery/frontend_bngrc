                ...
                {isTypeModalOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-sm bg-white rounded-3xl shadow-2xl z-[70] border border-slate-200"
                            style={{ padding: '32px' }}
                        >
                            <div className="flex items-center justify-between" style={{ marginBottom: '20px' }}>
                                ...
                                <button onClick={closeTypeModal} className="hover:bg-slate-100 rounded-full transition-colors" style={{ padding: '8px' }}>
                            ...
                            <form onSubmit={handleSaveType} className="space-y-4">
                                <div>
                                    <label className="block text-sm font-bold text-slate-700 mb-1" style={{ marginBottom: '8px' }}>Nom du dossier</label>
                                    <input
                                        type="text"
                                        value={typeName}
                                ...
                                <div className="flex gap-3" style={{ padding: '20px 0px' }}>
                                    <button
                                        type="button"
                                        onClick={closeTypeModal}
